...
var fragments = function (text)
{
    ...
    var mapping = {
        middleButton:element.bind(null, by.id('helloBtn')),
        warningAlert:element.bind(null, by.id('meetBtn')),
        input: element.bind(null, by.id('BIG')),
        header: element.bind(null, by.id('link'))
    };
